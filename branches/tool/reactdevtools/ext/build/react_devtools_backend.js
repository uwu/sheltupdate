	...
	/******/ [
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			__webpack_require__.d(__webpack_exports__, "c", function () {
				return /* binding */ getAllEnumerableKeys;
			});
			...
			__webpack_require__.d(__webpack_exports__, "m", function () {
				return /* binding */ utfEncodeString;
			});
			__webpack_require__.d(__webpack_exports__, "j", function () {
				return /* binding */ printOperationsArray;
			});
			__webpack_require__.d(__webpack_exports__, "e", function () {
				return /* binding */ getDefaultComponentFilters;
			});
			__webpack_require__.d(__webpack_exports__, "h", function () {
				return /* binding */ getInObject;
			});
			__webpack_require__.d(__webpack_exports__, "a", function () {
				return /* binding */ deletePathInObject;
			});
			__webpack_require__.d(__webpack_exports__, "k", function () {
				return /* binding */ renamePathInObject;
			});
			__webpack_require__.d(__webpack_exports__, "l", function () {
				return /* binding */ setInObject;
			});
			__webpack_require__.d(__webpack_exports__, "d", function () {
				return /* binding */ getDataType;
			});
			__webpack_require__.d(__webpack_exports__, "g", function () {
				return /* binding */ getDisplayNameForReactElement;
			});
			__webpack_require__.d(__webpack_exports__, "b", function () {
				return /* binding */ formatDataForPreview;
			});
			...
			function getSavedComponentFilters() {
				try {
					const raw = Object(storage["a" /* localStorageGetItem */])(
						constants["a" /* LOCAL_STORAGE_FILTER_PREFERENCES_KEY */],
					);
			...
			function saveComponentFilters(componentFilters) {
				Object(storage["b" /* localStorageSetItem */])(
					constants["a" /* LOCAL_STORAGE_FILTER_PREFERENCES_KEY */],
			...
			function getAppendComponentStack() {
				try {
					const raw = Object(storage["a" /* localStorageGetItem */])(
						constants["c" /* LOCAL_STORAGE_SHOULD_PATCH_CONSOLE_KEY */],
					);
			...
			function getBreakOnConsoleErrors() {
				try {
					const raw = Object(storage["a" /* localStorageGetItem */])(
						constants["b" /* LOCAL_STORAGE_SHOULD_BREAK_ON_CONSOLE_ERRORS */],
					);
			...
			function getShowInlineWarningsAndErrors() {
				try {
					const raw = Object(storage["a" /* localStorageGetItem */])(
						constants["d" /* LOCAL_STORAGE_SHOW_INLINE_WARNINGS_AND_ERRORS_KEY */],
					);
			...
			function formatDataForPreview(data, showFormattedValue) {
				if (data != null && hasOwnProperty.call(data, hydration["b" /* meta */].type)) {
					return showFormattedValue
						? data[hydration["b" /* meta */].preview_long]
						: data[hydration["b" /* meta */].preview_short];
				}
				...
				switch (type) {
					...
					case "array":
						if (showFormattedValue) {
							...
							const length = hasOwnProperty.call(data, hydration["b" /* meta */].size)
								? data[hydration["b" /* meta */].size]
								: data.length;
							return `Array(${length})`;
						}
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			function cleanForBridge(data, isPathAllowed, path = []) {
				if (data !== null) {
					...
					const cleanedData = Object(_hydration__WEBPACK_IMPORTED_MODULE_1__[/* dehydrate */ "a"])(
						data,
						cleanedPaths,
						unserializablePaths,
						path,
			...
			function copyToClipboard(value) {
				...
				const { clipboardCopyText } = window.__REACT_DEVTOOLS_GLOBAL_HOOK__; // On Firefox navigator.clipboard.writeText has to be called from
			...
			function copyWithDelete(obj, path, index = 0) {
				...
				const updated = Object(shared_isArray__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(obj)
					? obj.slice()
					: { ...obj };
...
*/
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			function dehydrate(data, cleaned, unserializable, path, isPathAllowed, level = 0) {
				...
				switch (type) {
					case "html_element":
						...
						return {
							inspectable: false,
							preview_short: Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* formatDataForPreview */ "b"])(
								data,
								false,
							),
							preview_long: Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* formatDataForPreview */ "b"])(
								data,
								true,
							),
							name: data.tagName,
					...
					case "react_element":
						...
						return {
							...
							name:
								Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* getDisplayNameForReactElement */ "g"])(data) ||
								"Unknown",
							type,
						};
					...
					case "object":
						...
						if (level >= LEVEL_THRESHOLD && !isPathAllowedCheck) {
							...
							const object = {};
							Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* getAllEnumerableKeys */ "c"])(data).forEach(
								(key) => {
			...
			function hydrate(object, cleaned, unserializable) {
				cleaned.forEach((path) => {
					const length = path.length;
					const last = path[length - 1];
					const parent = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* getInObject */ "h"])(
						object,
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			// EXPORTS
			__webpack_require__.d(__webpack_exports__, "b", function () {
				return /* binding */ registerRenderer;
			});
			__webpack_require__.d(__webpack_exports__, "a", function () {
				return /* binding */ patch;
			});
			__webpack_require__.d(__webpack_exports__, "c", function () {
				return /* binding */ unpatch;
			});
			...
			function registerRenderer(renderer, onErrorOrWarning) {
				const { currentDispatcherRef, getCurrentFiber, findFiberByHostInstance, version } = renderer; // Ignore React v15 and older because they don't expose a component stack anyway.
				...
				if (currentDispatcherRef != null && typeof getCurrentFiber === "function") {
					const { ReactTypeOfWork } = Object(backend_renderer["b" /* getInternalReactConstants */])(version);
			...
			function patch({ appendComponentStack, breakOnConsoleErrors, showInlineWarningsAndErrors }) {
					...
					try {
						...
						const overrideMethod = (...args) => {
							...
							const shouldShowInlineWarningsAndErrors =
								consoleSettingsRef.showInlineWarningsAndErrors && (method === "error" || method === "warn");
		...
		/***/ function (module, exports, __webpack_require__) {
			/* WEBPACK VAR INJECTION */ (function (process) {
				...
				src[t.COMPARATORTRIM] =
					"(\\s*)" + src[t.GTLT] + "\\s*(" + src[t.LOOSEPLAIN] + "|" + src[t.XRANGEPLAIN] + ")"; // this one has to use the /g flag
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
				...
				function getDisplayNameForFiber(fiber) {
					...
					switch (tag) {
						...
						case ForwardRef:
							...
							return (
								(type && type.displayName) || Object(utils["f" /* getDisplayName */])(resolvedType, "Anonymous")
							);
			...
			function attach(hook, rendererID, renderer, global) {
				...
				const { ImmediatePriority, UserBlockingPriority, NormalPriority, LowPriority, IdlePriority, NoPriority } =
					ReactPriorityLevels;
				const {
					overrideHookState,
				...
				const supportsTogglingSuspense =
					typeof setSuspenseHandler === "function" && typeof scheduleUpdate === "function"; // Tracks Fibers with recently changed number of error/warning messages.
				...
				const debug = (name, fiber, parentFiber, extraString = "") => {
					if (constants["n" /* __DEBUG__ */]) {
						...
						console.groupCollapsed(
							`[renderer] %c${name} %c${displayName} (${maybeID}) %c${parentFiber ? `${parentDisplayName} (${maybeParentID})` : ""} %c${extraString}`,
				...
				function isEffect(memoizedState) {
					...
					return (
						...
						hasOwnProperty("next") &&
						hasOwnProperty("tag") &&
						(deps === null || Object(isArray["a" /* default */])(deps))
					);
				}
				...
				function recordMount(fiber, parentFiber) {
					...
					if (isRoot) {
						...
						const displayName = getDisplayNameForFiber(fiber);
						const elementType = getElementTypeForFiber(fiber);
						const { _debugOwner } = fiber; // Ideally we should call getFiberIDThrows() for _debugOwner,
				...
				function handlePostCommitFiberRoot(root) {
					if (isProfiling && rootSupportsProfiling(root)) {
						if (currentCommitProfilingMetadata !== null) {
							const { effectDuration, passiveEffectDuration } = Object(
								backend_utils["g" /* getEffectDurations */],
							)(root);
				...
				function copyElementPath(id, path) {
					if (isMostRecentlyInspectedElement(id)) {
						Object(backend_utils["b" /* copyToClipboard */])(
							Object(utils["h" /* getInObject */])(mostRecentlyInspectedElement, path),
						);
					}
				}
				...
				if (
					Object(storage["c" /* sessionStorageGetItem */])(
						constants["g" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */],
					) === "true"
				) {
					startProfiling(
						Object(storage["c" /* sessionStorageGetItem */])(
  ...
  `;
			...
			class agent_Agent extends events["a" /* default */] {
				constructor(bridge) {
					...
					_defineProperty(this, "clearErrorsAndWarnings", ({ rendererID }) => {
					...
					_defineProperty(this, "clearErrorsForFiberID", ({ id, rendererID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "clearWarningsForFiberID", ({ id, rendererID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "copyElementPath", ({ id, path, rendererID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "deletePath", ({ hookID, id, path, rendererID, type }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "getProfilingData", ({ rendererID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "getOwnersList", ({ id, rendererID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "inspectElement", ({ id, path, rendererID, requestID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "logElementToConsole", ({ id, rendererID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "overrideSuspense", ({ id, rendererID, forceFallback }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "overrideValueAtPath", ({ hookID, id, path, rendererID, type, value }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "overrideContext", ({ id, path, rendererID, wasForwarded, value }) => {
					...
					_defineProperty(this, "overrideHookState", ({ id, hookID, path, rendererID, wasForwarded, value }) => {
						// Don't forward a message that's already been forwarded by the front-end Bridge.
						// We only need to process the override command once!
						if (!wasForwarded) {
							this.overrideValueAtPath({
					...
					_defineProperty(this, "overrideProps", ({ id, path, rendererID, wasForwarded, value }) => {
						// Don't forward a message that's already been forwarded by the front-end Bridge.
						// We only need to process the override command once!
						if (!wasForwarded) {
							this.overrideValueAtPath({
					...
					_defineProperty(this, "overrideState", ({ id, path, rendererID, wasForwarded, value }) => {
						// Don't forward a message that's already been forwarded by the front-end Bridge.
						// We only need to process the override command once!
						if (!wasForwarded) {
							this.overrideValueAtPath({
					...
					_defineProperty(this, "renamePath", ({ hookID, id, newPath, oldPath, rendererID, type }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "storeAsGlobal", ({ count, id, path, rendererID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(
						...
						({ appendComponentStack, breakOnConsoleErrors, showInlineWarningsAndErrors }) => {
					...
					_defineProperty(this, "viewAttributeSource", ({ id, path, rendererID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(this, "viewElementSource", ({ id, rendererID }) => {
						const renderer = this._rendererInterfaces[rendererID];
					...
					_defineProperty(
						...
						lodash_throttle_default()((rendererID, id) => {
							...
							if (path !== null) {
								Object(storage["e" /* sessionStorageSetItem */])(
									constants["e" /* SESSION_STORAGE_LAST_SELECTION_KEY */],
									JSON.stringify({
										rendererID,
										path,
									}),
					...
					const persistedSelectionString = Object(storage["c" /* sessionStorageGetItem */])(
						constants["e" /* SESSION_STORAGE_LAST_SELECTION_KEY */],
					);
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			"use strict";
			__webpack_require__.r(__webpack_exports__);
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BRIDGE_PROTOCOL", function () {
			...
			class Bridge extends _events__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
				constructor(wall) {
					...
					_defineProperty(this, "overrideValueAtPath", ({ id, path, rendererID, type, value }) => {
						switch (type) {
							case "context":
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			function setup(hook) {
				...
				const { initBackend } = __webpack_require__(32);
			...
			function J(a, b) {
				for (var c = [], d = null, e = c, p = 0, q = [], u = 0; u < b.length; u++) {
					...
					b: {
						...
						r = B().get(t.primitive);
						if (void 0 !== r)
							for (l = 0; l < r.length && l < m.length; l++)
						...
						G(d)
							...
							: null != d &&
								(M(d) &&
									(d = L(
										d,
										c + (!d.key || (h && h.key === d.key) ? "" : ("" + d.key).replace(N, "$&/") + "/") + a,
									)),
								b.push(d)),
						1
					);
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			function attach(hook, rendererID, renderer, global) {
				...
				function copyElementPath(id, path) {
					...
					if (inspectedElement !== null) {
						Object(backend_utils["b" /* copyToClipboard */])(
							Object(utils["h" /* getInObject */])(inspectedElement, path),
						);
					}
				}
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			// EXPORTS
			__webpack_require__.d(__webpack_exports__, "default", function () {
				return /* binding */ setupNativeStyleEditor;
			});
