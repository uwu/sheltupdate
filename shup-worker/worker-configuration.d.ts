/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 43dac7ad58fd143ffbf6ea7a56418ce8)
...
declare namespace Cloudflare {
	...
	interface Env {
		VPC_PRODUCTION: Fetcher;
		VPC_STAGING: Fetcher;
		BASE_V1: "https://discord.com/api";
		BASE_V2: "https://updates.discord.com";
		VPC_MAP: {"inject.shelter.uwu.network":"VPC_PRODUCTION","staging.shelter.uwu.network":"VPC_STAGING"};
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_V1" | "BASE_V2" | "VPC_MAP">> {}
}
...
> = T extends new(
	...args: any[]
) => Rpc.WorkerEntrypointBranded ? Fetcher<InstanceType<T>>
...
> =
	& (T extends Rpc.EntrypointBranded ? Rpc.Provider<T, Reserved | "fetch" | "connect">
		: unknown)
	& {
...
> = T extends new(
	...args: any[]
) => Rpc.WorkerEntrypointBranded ? LoopbackServiceStub<InstanceType<T>>
	: T extends new(
		...args: any[]
	) => Rpc.DurableObjectBranded ? LoopbackDurableObjectClass<InstanceType<T>>
...
declare namespace Rpc {
	...
	type MethodOrProperty<V> = V extends (...args: infer P) => infer R ? (...args: UnstubifyAll<P>) => Result<Awaited<R>>
		: Result<Awaited<V>>;
	// Type for the callable part of an `Provider` if `T` is callable.
	// This is intersected with methods/properties.
	type MaybeCallableProvider<T> = T extends (...args: any[]) => any ? MethodOrProperty<T>
		: unknown;
...
declare namespace Cloudflare {
	...
	// present.
	type GlobalProp<K extends string, Default> = K extends keyof GlobalProps ? GlobalProps[K]
		: Default;
	...
	type Exports = {
		[K in keyof MainModule]:
			...
			(K extends GlobalProp<"durableNamespaces", never> ? MainModule[K] extends new(
					...args: any[]
				) => infer DoInstance ? DoInstance extends Rpc.DurableObjectBranded ? DurableObjectNamespace<DoInstance>
